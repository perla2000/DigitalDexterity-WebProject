        ...
        <div id="main">
          ...
          <form id="form1">
            <fieldset>
              ...
              <h2>
                There are three worksheets with every new workbook. You can
                change that automatic number if you want to
              </h2>
              ...
              <h2>
                To add a new row, click a cell in the row immediately above
              ...
              <h2>
                Which formula can add all the numeric values in a range of
                cells, ignoring those which are not numeric, and place the
              ...
              <label for="if_info">
                ...
                Right-click on the spreadsheet and select INSERT - ENTIRE
                COLUMN.
              </label>
