          ...
          <form id="form1">
            <fieldset>
              ...
              <label for="overtype">
                ...
                Create layouts for slides, handouts, and notes using the Master
                Layout dialog box in slide master view
              </label>
              ...
              <h2>
                ...
                different design template from the other slides, what do you do?{" "}
              </h2>
              ...
              <h2>
                Using a custom animation effect, how do you make text appear on
                a slide letter by letter?
              </h2>
              ...
              <h2>
                You've customized a design template in one presentation and you
                want to use it in another presentation. What's the best way to
                do this?{" "}
              </h2>
              <label for="if_string">
                <input type="radio" name="open" value="0" id="if_string" />
                Use the Browse feature in the Slide Design task pane to find the
                file that has your design template and apply it to the current
                file.
              </label>
              <label for="if_join">
                <input type="radio" name="open" value="0" id="if_join" />
                Copy and paste the slide with the design template you want into
                the new presentation; inserted slides will inherit the design
              </label>
              <label for="if_info">
              ...
              <label for="if_string">
                ...
                (point to Picture, and then click Clip Art) to open the Clip Art
                task pane and insert the picture.
              </label>
              <label for="if_join">
                <input type="radio" name="var" value="0" id="if_join" />
                Select the placeholder on the slide, and then press DELETE. Then
                use the Insert menu (point to Picture, and then click Clip Art)
              ...
              <label for="if_info">
                ...
                Insert menu (point to Picture, and then click Clip Art) to open
              ...
              <label for="if_string">
                ...
                Press ESC to get back into normal view; click the correct slide
                thumbnail in normal view; then click the Resume Slide Show
                button.
              </label>
              <label for="if_join">
